...
#ifndef AP_PROXIMITY_RPLIDAR_EXPRESSSCAN_ENABLED
#define AP_PROXIMITY_RPLIDAR_EXPRESSSCAN_ENABLED (AP_PROXIMITY_RPLIDARA2_ENABLED && (HAL_PROGRAM_SIZE_LIMIT_KB > 1024))
#endif
...
#ifndef AP_PROXIMITY_JIYI_CAN_ENABLED
#define AP_PROXIMITY_JIYI_CAN_ENABLED AP_PROXIMITY_BACKEND_DEFAULT_ENABLED && HAL_MAX_CAN_PROTOCOL_DRIVERS
#endif